...
class Issue(models.Model):
    ...
    comicvine_id = models.IntegerField()  # Note: not a unique field because multiple covers have the same id
    ...
    cover_url = models.CharField("Comicvine cover image URL", max_length=500)  # Uses the <small_url> tag in the CV api
    on_sale_date = models.DateField()  # Note: on-sale date reflects cover 1 and print 1
